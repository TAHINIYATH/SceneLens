...
class _CameraScreenState extends State<CameraScreen> {
  ...
  void initState() {
    ...
    // keep this 3 lines if you are using defaul custom trained model of mlkit.......
    // final ImageLabelerOptions options =
    //     ImageLabelerOptions(confidenceThreshold: 0.5);
    // imageLabeler = ImageLabeler(options: options);
//*** it ends here

    // call loadmodel() method for custom trained model of mlkit if not commend out
    loadmodel();
...
// loadmodel() method for custom trained model
  loadmodel() async {
    ...
    //remove final keyword if you are using custom trained model of google_mlkit_image_labeling
    imageLabeler = ImageLabeler(options: options);
  }
...
//**************it ends here
  ...
  // getModelpath is the function for customtrained model for classification
